...
?>
	...
	<link rel="manifest" href="wp-content/themes/Divi/images/site.webmanifest">
	<link rel="mask-icon" href="wp-content/themes/Divi/images/safari-pinned-tab.svg" color="#5bbad5">
	...
	<meta property="og:url" content="<?php echo "${protocol}://${domain}" ?>" />
